...
var findDirectionLeg = function(initialRoutePoint, finalRoutePoint){
	...
	var initialRoutePointPromise = e.findByExternalCode('ExternalCode', initialRoutePoint.externalCode).then(function(i){result.i = i;});
	var finalRoutePointPromise = e.findByExternalCode('ExternalCode', finalRoutePoint.externalCode).then(function(f){result.f = f;});
